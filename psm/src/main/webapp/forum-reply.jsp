	...
	<td height="24" colspan="2" background="skin/images/tbg.gif">&nbsp;评论&nbsp;</td>
		...
		<tr >
			<td align="right" bgcolor="#FAFAF1" height="22">
				<span >
					<img src='${pageContext.request.contextPath}/forumpic/1.jpg' height='50px' width='50px'/>
				</span>
			</td>
						...
						<tr >
							...
							<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
								...
								&nbsp;<span><a href="${pageContext.request.contextPath}/huifu.jsp?fid=${forumpost.forumid}&evaid=${parent.evaid}">【回复】</a></span>
	                              ...
	                              <!-- 二级评论 -->
	                             <c:if test="${!empty parent.childEvaluate}">
	                                 <c:forEach items="${ parent.childEvaluate}" var="child">
										<tr>
											<td align="right" bgcolor="#FAFAF1" height="22">
													<span >
														<img src='${pageContext.request.contextPath}/images/tx.png' height='50px' width='50px'/>
