...
<link rel="stylesheet" type="text/css" href="skin/css/main.css" />
	...
	<script type="text/javascript">
        ...
        $(function(){
            $.ajax({
                type:'GET',
                url:'${pageContext.request.contextPath}/not/getLimitList',
                dataType:'json',
            ...
            $.ajax({
                type:'GET',
                url:'${pageContext.request.contextPath}/usual/getForamList',
                dataType:'json',
                success:function(msg){
						$(msg).each(function (index,item) {
                            var str='<ul class="notice-list">' +
                                '<li class="ue-clear">' +

                                ' <span><img src="${pageContext.request.contextPath}/images/tx.png" height="50px" width="50px"/> '+
                                '<a href="role.jsp"class="notice-title">'+item.forumtitle+'</a>' +
								'</span> 发布时间：2018-12-25' +
                                '</li>' +
                                '</ul>'
                            $("#tz").append(str)
