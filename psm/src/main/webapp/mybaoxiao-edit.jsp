<%@ page language="java"  import="com.ujiuye.usual.usualBean.BaoXiao,java.util.*" pageEncoding="UTF-8"%>
	...
	<script type="application/javascript">
        ...
        function commit(obj){
            ...
            $.ajax({
                ...
                data:{"_method":"put","bxstatus":obj,"bxid":$("#bxid").val(),"result":$("#pizhu").text(),"paymode":$("#paymode").val(),"bxremark":$("#bxremark").val(),"bxtime":$("#bxtime").val(),"totalmoney":$("#totalmoney").val()},
                dataType:"json",
                success:function(resultData){
                      if(resultData.st==200){
                           window.location.href="${pageContext.request.contextPath}/mybaoxiao-base.jsp"
					  }
                }
            });
        }
