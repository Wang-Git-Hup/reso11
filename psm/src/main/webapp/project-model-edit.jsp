...
<script type="text/javascript">
	$(function () {
		...
		$.ajax({
			...
			success:function (msg1) {
				...
				var analysisFk = msg1[0].analysisFk;
				$.ajax({
				...
				$("#modname").val(msg1[0].modname);
				$("#simpledis").text(msg1[0].simpledis);
				$("#detaileddis").text(msg1[0].detaileddis);
				$("#remark").text(msg1[0].remark);
				$("option[name=levels]").each(function () {
					if (msg1[0].level == $(this).val()){
	...
	function save() {
		$.ajax({
			url:"${pageContext.request.contextPath}/mou/updateModuleById/",
			type:"post",
