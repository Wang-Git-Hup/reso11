...
<head>
    ...
    <script type="text/javascript">
             $(function(){
                 $.ajax({
                     type:'GET',
                     url:'${pageContext.request.contextPath}/usual/getOneByEid?mark=1',
                     dataType:'json',
...
<table width="98%" align="center" border="0" cellpadding="3"
    ...
    <tr id="sp">
        <td colspan="3" background="skin/images/frame/wbg.gif" bgcolor="#EEF4EA"
            class='title'>
            <span>员工论坛</span> |<span>生活广场</span> |<span>租房信息</span><a href='${pageContext.request.contextPath}/forum-add.jsp' style='padding-left: 1260px'><font size="5">发帖</font></a>
        </td>
    </tr>
