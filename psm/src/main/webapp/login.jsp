...
<script type="text/javascript">
	function changecode() {
		$("#codeimg").attr("src","${pageContext.request.contextPath}/emp/login?time="+new Date().getTime())
	}
	function login() {
										...
										<TABLE id=table2 cellSpacing=1 cellPadding=0 width="100%"
											...
											<TBODY>
												...
												<TR>
													...
													<img id="codeimg" src="${pageContext.request.contextPath}/emp/login" onclick="changecode()">
