...
<script type="text/javascript">
    $(function () {
        $.ajax({
            url:"${pageContext.request.contextPath}/attch/filelist",
            type:"get",
            success:function (msg) {
                $(msg).each(function (index,item) {
                    var str = "<tr name='trs' align='center' bgcolor='#FFFFFF' onMouseMove="+"javascript:this.bgColor='#FCFDEE';"+" onMouseOut="+"javascript:this.bgColor='#FFFFFF';"+" height='22' >" +
                        ...
                        "<td>2015-02-03</td>" +
                        "<td>2015-06-03</td>" +
                        "<td><a href='${pageContext.request.contextPath}/attch/download?path="+item.path+"'>下载</a> |<a id='a_"+item.id+"' href='javascript:deleteById("+item.id+")'>删除</a> |<a href='project-file-edit.jsp?"+item.id+"'>编辑</a> | <a href='project-file-look.jsp?"+item.id+"'>查看详情</a></td>" +
                        "</tr>";
                    $("#endtr").before(str);
                })
            }
...
<td height="28" colspan="12">
	...
	<a href="${pageContext.request.contextPath}/attch/outExcle" class="coolbg">&nbsp;导出Excel&nbsp;</a>
</td>
</tr>
